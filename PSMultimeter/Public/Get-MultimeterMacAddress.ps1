function Get-MultimeterMacAddress
{
    <#
    .SYNOPSIS
    Get MAC statistics from the Allegro Multimeter via RESTAPI.
    ...
    Get-MultimeterMacAddress -Hostname 'allegro-mm-6cb3' -Credential $Credential
    #Ask for credential then get MAC statistics from Allegro Multimeter using provided credential

    .EXAMPLE
    Get-MultimeterMacAddress -Hostname 'allegro-mm-6cb3' -Timespan 3600 -SortBy Bytes -Count 1 -Reverse
    ...
    process
    {
        ...
        $SessionURL = ('{0}/mac_paged?sort={1}&reverse={2}&page={3}&count={4}&timespan={5}' -f $BaseURL,
